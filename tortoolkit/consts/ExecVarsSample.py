try:
    ...
    class ExecVars:
        ...
        API_HASH = "be8e7ec75d5b3a198b3ff62ceb045a4b"
        API_ID = 6308904
        BOT_TOKEN = "5916956423:AAHyzr0VPqtiD-kkJpU02El4ny5CKjRsZqk"
        BASE_URL_OF_BOT = "http://13.127.192.17"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001838617601]
        OWNER_ID = 5082214578
